...
export function Home() {
  ...
  // github copilot create a function called handleSignOut
  // that calls the signOut function from useAuth
  // and then display an Alert with the title "Sucesso" and message "Você saiu do app"
  // if fails, display an Alert with the title "Erro SignOut" and message "Ocorreu um erro ao tentar sair do app"
  const handleSignOut = async () => {
    try {
      await signOut();
      Alert.alert("Sucesso", "Você saiu do app");
    } catch (error) {
